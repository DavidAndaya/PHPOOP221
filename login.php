...
<div class="container-fluid login-container rounded shadow" >
  ...
  <form method="post">
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="user" placeholder="Lagaye eng pengelen." >
    </div>
    <div class="form-group">
      <label for="password">Password:</label>
      <input type="password" class="form-control" name="pass" placeholder="Password dine.">
    </div>
    <div class="container">
      <div class="row gx-1">
